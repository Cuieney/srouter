package com.cuieney.srouter_api.thread;
...
public class DefaultThreadFactory implements ThreadFactory {
    ...
    public Thread newThread(@NonNull Runnable runnable) {
        ...
        SRouter.logger.info(Consts.TAG, "Thread production, name is [" + threadName + "]");
        ...
        thread.setUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
            ...
            public void uncaughtException(Thread thread, Throwable ex) {
                SRouter.logger.info(Consts.TAG, "Running task appeared exception! Thread [" + thread.getName() + "], because [" + ex.getMessage() + "]");
            }
        });
        return thread;
    }
