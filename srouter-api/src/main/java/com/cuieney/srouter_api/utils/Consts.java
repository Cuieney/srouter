package com.cuieney.srouter_api.utils;
...
public final class Consts {
    public static final String SDK_NAME = "SRouter";
    ...
    public static final String ROUTE_ROOT_PAKCAGE = "com.cuieney.android.srouter.routes";
